...
5. Open <https://booking.example.com>/setup.php in a browser, paste the SETUP_TOKEN into the form (never into the URL), fill in the venue name "<Venue name>", timezone <America/Chicago>, <number> stations, admin username <owner>, and let me type the admin password. Submit once.
